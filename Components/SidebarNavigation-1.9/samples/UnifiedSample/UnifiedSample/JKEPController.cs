		...
		public override void ViewWillAppear(bool animated)
		{
			...
			if (payees.status == "success")
			{
				...
				//var result = docdb.savecheck(myCheck);
					...
					Auth result = usaepayservice.auth(payeename, this.cardnumber.Text, this.dateentered.Text, this.amountcharged.Text, this.transdesc.Text, this.codeentered.Text);
					loadingOverlay.Hide();
					...
					if (result != null)
					{
						...
						String authresp = "Auth Code: " + result.RefNumber + "\n" +
